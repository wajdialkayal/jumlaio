...
<div class="card">
    <div class="card-body">
        ...
        <div class="browser-preview border shadow">
            <div id="web-page-preview">
                ...
                <div class="container p-5" id="body-preview">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-12">
                            <button type="button" class="btn float-right btn-back-to-top-preview"
                                id="btn-back-to-top-preview">
                    ...
                    <div class="container text-center text-md-left">
                        <div class="row text-center text-md-left mt-3 pb-3">
                            ...
                            <div class="col-md-4 col-lg-3 col-xl-3 text-center">
                                ...
                                <a>
                                    <img src="{{ asset('images/badges/app-store-badge.svg') }}" alt="app-store"
                                        width="125" height="30">
                                </a>
