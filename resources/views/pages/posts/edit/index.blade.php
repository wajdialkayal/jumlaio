        ...
        <div class="row">
            ...
            <div class="col-md-10 settings-col border shadow-sm">
                ...
                <div class="card mt-3 shadow-sm">
                    <div class="card-body">
                        <h4 class="card-title"> <a href="{{ URL::previous() }}" class="btn btn-light btn-circle border"> <i class="fas fa-arrow-left fa-1x"></i> </a> Edit Post</h4>
                        
                        @include('pages.posts.edit.partials.create-form')
                    </div>
                </div>
